...
#ifndef __ADS_MVN_HEADERS
#define __ADS_MVN_HEADERS
...
NumericVector rMVN_vec(NumericVector mu_,
		       NumericMatrix L_, bool isPrec){

  NumericMatrix x = rMVN_(1, mu_, L_, isPrec);
  NumericVector res(mu_.size());
  res = x(0,_);
  return(res);
